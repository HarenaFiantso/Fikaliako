...
/**
 * Parses the combinable query filters (project book ch. 4.3) into an
 * [EstablishmentFilters], rejecting unknown enum/amenity values up front with a
 * 400 rather than letting them reach the database.
 */
