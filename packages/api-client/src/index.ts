...
export type RankingTopic = Schemas['RankingTopic'];
export type RankingCatalog = Schemas['RankingCatalog'];
export type RankingPage = Schemas['RankingPage'];
...
export type EstablishmentProposal = Schemas['EstablishmentProposal'];
export type ContributionReceipt = Schemas['ContributionReceipt'];
